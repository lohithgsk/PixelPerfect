...
>
          ...
          <Text className="text-m text-gray-500 ml-0 m-2 mb-6">
            ...
            {generatedImage && (
              ...
              <Wrap>
                ...
                {uploadResponse && (
              <Text
                className="mt-6 p-4 border border-green-500 rounded-lg bg-green-50 shadow-md flex"
                mb={4}
                width={"425px"}
              >
        ...
        <Heading
          ...
          {loadingSummary ? (
            ...
            <Text
              className="mt-6 p-4 border border-yellow-600 rounded-lg bg-violet-400 shadow-md bg-opacity-20 text-xl "
              mb={4}
            >
